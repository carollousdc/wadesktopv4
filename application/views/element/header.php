<?php if (!isset($_SESSION['email'])) header("location: login"); ?>
<?php $dataUser = $this->user_sql->getUser($_SESSION['username']); ?>
<!DOCTYPE html>
<html>
  ...
  <div class="wrapper">
    ...
    <aside class="main-sidebar sidebar-dark-primary elevation-4">
      ...
      <a href="Dashboard" class="brand-link">
        ...
        <span class="brand-text font-weight-light">SAPCoRP 3</span>
      </a>
